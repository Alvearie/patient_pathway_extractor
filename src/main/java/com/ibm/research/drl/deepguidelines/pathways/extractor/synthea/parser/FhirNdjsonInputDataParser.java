...
public class FhirNdjsonInputDataParser extends AbstractInputDataParser {
    ...
    private static final Set<SyntheaMedicalTypes> SYNTHEA_MEDICAL_TYPES_YIELDING_START_STOP_PATHWAY_EVENTS = new ObjectOpenHashSet<>(Arrays.asList(
        SyntheaMedicalTypes.CAREPLANS,
        SyntheaMedicalTypes.CONDITIONS,
        SyntheaMedicalTypes.ENCOUNTERS,
        SyntheaMedicalTypes.PROCEDURES));

    private static final Set<SyntheaMedicalTypes> SYNTHEA_MEDICAL_TYPES_YIELDING_ISOLATED_PATHWAY_EVENTS = new ObjectOpenHashSet<>(Arrays.asList(
    ...
    @Override
    public Set<SyntheaMedicalTypes> getMedicalTypesYieldingStartStopPathwayEvents() {
        return SYNTHEA_MEDICAL_TYPES_YIELDING_START_STOP_PATHWAY_EVENTS;
    }
    
    @Override
    public Set<SyntheaMedicalTypes> getMedicalTypesYieldingIsolatedPathwayEvents() {
        return SYNTHEA_MEDICAL_TYPES_YIELDING_ISOLATED_PATHWAY_EVENTS;
    }
            ...
            try {
                ...
                if (this.totalNumberOfLines > 0) {
                    ...
                    if (!SyntheaMedicalTypes.PATIENTS.equals(medicalType)) {
                        ...
                        if (SYNTHEA_MEDICAL_TYPES_YIELDING_START_STOP_PATHWAY_EVENTS.contains(medicalType)) {
